// https://github.com/DestinyItemManager/DIM/blob/master/src/app/dim-ui/AutoRefresh.tsx

export default `import { autoRefreshEnabledSelector } from 'app/inventory/selectors';
