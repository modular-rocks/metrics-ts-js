// https://github.com/DestinyItemManager/DIM/blob/master/src/app/gear-power/GearPower.tsx
export default `import { AlertIcon } from 'app/dim-ui/AlertIcon';
...
export default function GearPower() {
  ...
  const maxItemsSearchString = classFilterString;
